...
files.forEach(file => {
  ...
  const hasUseStateImport = content.match(/import.*useState.*from.*'react'/)||content.match(/import.*useState.*from.*"react"/);
  const hasUseEffectImport = content.match(/import.*useEffect.*from.*'react'/)||content.match(/import.*useEffect.*from.*"react"/);
  const hasReactImport = content.match(/import.*React.*from.*'react'/)||content.match(/import.*React.*from.*"react"/);
